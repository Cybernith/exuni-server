...
from entrance.views import EntrancePackageCreateView, EntrancePackageDetailView, StoreReceiptCreateView, \
    StoreReceiptDetailView, EntrancePackageFileUpdateView, EntrancePackageApiView
...
urlpatterns = [
    ...
    url(r'^fileUpload/(?P<pk>[0-9]+)$', EntrancePackageFileUpdateView.as_view(), name='ثntrancePackageFileUpdateView'),
